...
**深度参与要求**：每角色200字+，包含问题诊断、方案评估、风险管控、行动方案
...
do {
  ...
  for 角色 in 当前模式.核心参与角色:
    [角色]: 问题诊断 + 方案评估 + 风险管控 + 行动方案 （进行分段输出，可以使用emoji）
